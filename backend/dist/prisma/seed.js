...
async function main() {
    ...
    const usersToSeed = [
        ...
        { name: "Rahul", email: "rahul@mail.com", status: "ACTIVE", balance: 4067 },
        { name: "Amit", email: "amit@mail.com", status: "VIP", balance: 83000 },
        { name: "Neha", email: "neha@mail.com", status: "ACTIVE", balance: 2407 },
        { name: "Priya", email: "priya@mail.com", status: "ACTIVE", balance: 41500 },
        { name: "Sam", email: "sam@mail.com", status: "EXPIRED", balance: 2407 },
    ];
    const seededUsers = [];
    ...
    for (const t of tradesData) {
        ...
        await prisma.trade.create({
            data: {
                ...
                pnl: t.pnl,
                status: t.status,
                quantity: t.entry ? (500 / t.entry) : 0,
