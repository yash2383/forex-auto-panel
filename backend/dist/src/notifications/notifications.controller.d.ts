...
export declare class NotificationsController {
    ...
    getAudiencePreview(segment: NotificationAudience, res: Response): Promise<Response<any, Record<string, any>>>;
    ...
    updateEventSetting(id: string, body: any, req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
