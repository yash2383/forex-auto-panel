...
export class AdminController {
  ...
  async createPartner(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.createPartner(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async createPlan(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.createPlan(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updatePlan(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updatePlan(
        user.id,
        id,
        body,
        this.getClientIp(req),
  ...
  async deletePlan(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.deletePlan(
        user.id,
        id,
        this.getClientIp(req),
      );
  ...
  async updateSettings(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateSettings(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updateFinancialSettings(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateFinancialSettings(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updateDistributionSettings(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateDistributionSettings(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updateSystemSettings(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateSystemSettings(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updateReferralSettings(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateReferralSettings(
        user.id,
        body,
        this.getClientIp(req),
      );
  ...
  async updateReferralStatus(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateReferralStatus(
        user.id,
        id,
        status,
        this.getClientIp(req),
  ...
  async publishTradeRecord(@Param('id') id: string, @Res() res: Response) {
    try {
      const result = await this.adminService.setTradeRecordStatus(
        id,
        'published',
      );
      if ('error' in result)
  ...
  async approvePayment(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.approvePayment(
        user.id,
        id,
        this.getClientIp(req),
      );
  ...
  async rejectPayment(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.rejectPayment(
        user.id,
        id,
        body.remark || '',
        this.getClientIp(req),
  ...
  async verifyPayment(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.verifyPayment(
        user.id,
        id,
        this.getClientIp(req),
      );
  ...
  async reverseTransaction(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.reverseTransaction(
        user.id,
        id,
        body.reason,
        this.getClientIp(req),
  ...
  async bulkDistributeProfit(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.bulkDistributeProfit(
        user.id,
        this.getClientIp(req),
        body,
      );
  ...
  @Post('profit-distributions/preview')
  @Roles('SUPER_ADMIN', 'MANAGER', 'VIEWER')
  ...
  @Post('profit-distributions/batches/:batchId/reverse')
  @Roles('SUPER_ADMIN')
  async reverseDistribution(
    ...
    try {
      ...
      const result = await this.adminService.reverseDistribution(
        user.id,
        batchId,
        reason,
        this.getClientIp(req),
  ...
  @Roles('SUPER_ADMIN')
  async deleteProfitDistribution(
    @Param('id') id: string,
    @Res() res: Response,
  ) {
    try {
  ...
  async updateInquiryStatus(
    ...
    try {
      const result = await this.adminService.updateInquiryStatus(
        id,
        body.status,
      );
      if ('error' in result)
  ...
  async updateInitiatedPayment(
    ...
    try {
      const user = (req as any).user;
      const result = await this.adminService.updateInitiatedPayment(
        id,
        body,
        user.id,
        this.getClientIp(req),
