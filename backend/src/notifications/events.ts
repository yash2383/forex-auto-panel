...
export const EVENT_REGISTRY: Record<NotificationEvent, EventDefinition> = {
  ...
  [NotificationEvent.PAYMENT_SUBMITTED]: {
    ...
    channels: [NotificationChannel.BELL, NotificationChannel.SOCKET, NotificationChannel.TOAST],
  ...
  [NotificationEvent.PAYMENT_APPROVED]: {
    ...
    channels: [NotificationChannel.BELL, NotificationChannel.PUSH, NotificationChannel.EMAIL, NotificationChannel.TOAST],
  ...
  [NotificationEvent.TRADE_CLOSED]: {
    ...
    priority: NotificationPriority.MEDIUM,
    severity: NotificationSeverity.SUCCESS,
    channels: [NotificationChannel.BELL, NotificationChannel.PUSH, NotificationChannel.TOAST],
    title: 'Trade Closed',
  ...
  [NotificationEvent.PLAN_EXPIRING]: {
    ...
    priority: NotificationPriority.HIGH,
    severity: NotificationSeverity.WARNING,
    channels: [NotificationChannel.BELL, NotificationChannel.PUSH, NotificationChannel.EMAIL],
  ...
  [NotificationEvent.REPORT_READY]: {
    ...
    priority: NotificationPriority.LOW,
    severity: NotificationSeverity.INFO,
    channels: [NotificationChannel.BELL, NotificationChannel.EMAIL, NotificationChannel.TOAST],
    title: '📄 Report Ready',
