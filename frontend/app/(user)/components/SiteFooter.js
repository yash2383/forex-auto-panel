...
export default function SiteFooter() {
  return (
    <footer className="mx-auto w-full max-w-7xl border-t border-white/5 px-4 pb-14 pt-10 text-white sm:px-6 lg:px-8">
      ...
      <nav className="mt-6 flex flex-wrap gap-6 text-sm font-medium text-neutral-400">
        <Link href="/infrastructure" className="transition-colors hover:text-white">Infrastructure</Link>
        <Link href="/pricing" className="transition-colors hover:text-white">Pricing</Link>
        <Link href="/past-trades" className="transition-colors hover:text-white">Past Trades</Link>
        <Link href="/dashboard" className="transition-colors hover:text-white">Dashboard</Link>
        <Link href="/profit-simulator" className="transition-colors hover:text-white">Profit Simulator</Link>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-4 text-xs text-neutral-500">
        ...
        <p className="mt-6 w-full text-xs text-neutral-500">
          Trading involves financial risk. Tradebot does not guarantee profits. Always invest responsibly.
        </p>
      </div>
    </footer>
  );
