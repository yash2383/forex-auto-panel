    ...
    <>
      ...
      <SectionCard title="Support" description="Submit support request, contact details, and help resources.">
        <div className="mt-5 rounded-lg border border-white/10 bg-white/[0.03] p-5">
          ...
          <a href="mailto:hello@forex-auto-panel.com" className="mt-5 inline-flex h-11 items-center rounded-lg bg-green-500 px-5 text-sm font-bold text-black">Contact Support</a>
        </div>
      </SectionCard>
      <Disclaimer />
    </>
